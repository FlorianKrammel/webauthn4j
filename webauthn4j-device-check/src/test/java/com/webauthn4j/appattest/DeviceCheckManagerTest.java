...
class DeviceCheckManagerTest {
    ...
    void validate_test(){
        ...
        DeviceCheckManager deviceCheckManager = new DeviceCheckManager(new TrustAnchorCertPathTrustworthinessValidator(trustAnchorsResolver), objectConverter);
    ...
    private ObjectConverter createObjectConverter() { //TODO
